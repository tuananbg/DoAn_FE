...
@Component({
  selector: 'app-task-detail-management',
  templateUrl: './task-detail-management.component.html',
  styleUrls: ['./task-detail-management.component.less']
})
export class TaskDetailManagementComponent implements OnInit,AfterViewChecked {
  ...
  ngOnInit() {
    ...
    this.addForm = this.formBuilder.group({
      ...
      startDay: new FormControl({ value: '', disabled: true }),
      endDay: new FormControl({ value: '', disabled: true }),
      employeeCode: new FormControl({ value: '', disabled: true }),
      managerCode: new FormControl({ value: '', disabled: true }),
      projectCode: new FormControl({ value: '', disabled: true }),
  ...
  goBack() {
    this.router.navigate(['/project-person']);
  }
